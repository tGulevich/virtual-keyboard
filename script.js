            ...
            el.addEventListener('click', (evt) => {
                if (evt.target.textContent === 'CapsLock') {
                    ...
                    if (evt.target.classList.contains('active')) {
                        this.setSymbols(keys, eval('KEY_UPPER_' + this.lang));
                    } else {
                        this.setSymbols(keys, eval('KEY_' + this.lang));   
                    }
                } else {
...
window.onload = () => {
    ...
    keyboard.setSymbols(KEYS, eval('KEY_' + keyboard.lang));
